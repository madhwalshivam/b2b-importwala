...
$router->get('/factories/{slug}', 'Web\CatalogController@factoryBySlug');
$router->get('/factory/{code}', 'Web\CatalogController@factoryCodeRedirect');
$router->get('/factory', 'Web\CatalogController@factoriesDirectory');
