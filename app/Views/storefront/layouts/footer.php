    ...
    <div class="md:hidden">
        ...
        <div class="bg-white border-b border-gray-100 px-4 py-6 space-y-4">
            <img src="<?= asset('images/mudsor-logo.png') ?>" alt="Mudsor Logo"
                ...
                onerror="this.onerror=null; this.src='https://via.placeholder.com/160x48?text=MUDSOR';">
            ...
            <form action="#" method="POST" @submit.prevent="alert('Thank you for subscribing to Mudsor updates!')"
            ...
            <div>
                ...
                <div x-show="openSection === 'account'" x-collapse class="px-4 pb-4 space-y-2.5">
                    ...
                    <a href="<?= url('cart') ?>" class="block text-gray-600 hover:text-red-600 font-medium">Shopping
                        Cart</a>
                    <a href="https://wa.me/919217714452?text=Hi%20Mudsor%2C%20I%20need%20help%20with%20my%20order."
        ...
        <div class="bg-gray-900 px-4 pt-5 pb-20 text-center space-y-3">
            <p class="text-[10px] text-gray-400 leading-relaxed">
                &copy; <?= date('Y') ?> Mudsor (Rughwani Enterprises) &middot; GSTIN: 07FLOPR6641L1Z8 &middot; All
                Rights Reserved.
            </p>
    ...
    <div class="hidden md:block">
        ...
        <div class="container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-4 space-y-4">
                <div class="flex items-center space-x-2">
                    <img src="<?= asset('images/mudsor-logo.png') ?>" alt="Mudsor Logo"
                        ...
                        onerror="this.onerror=null; this.src='https://via.placeholder.com/220x60?text=MUDSOR';">
                </div>
                <p class="text-xs text-gray-500 font-normal leading-relaxed pr-4">
                    Mudsor is India's leading brand for heavy-duty electric scooter accessories, crash guards, and
            ...
            <div class="lg:col-span-2 space-y-3">
                ...
                <ul class="space-y-2.5 text-xs text-gray-600 font-medium">
                    ...
                    <li><a href="<?= url('about-us') ?>" class="hover:text-red-600 transition">About Mudsor</a></li>
                ...
                <ul class="space-y-2.5 text-xs text-gray-600 font-medium">
                    ...
                    <li><a href="<?= url('cart') ?>"
                            class="hover:text-red-600 transition flex items-center space-x-1.5"><i
                                ...
                                Cart</span></a></li>
                    <li><a href="https://wa.me/919217714452?text=Hi%20Mudsor%2C%20I%20need%20help%20with%20my%20order."
                            target="_blank" rel="noopener noreferrer"
        ...
        <div class="bg-gray-50 border-t border-gray-900 py-5 text-gray-500">
            <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
                <p class="text-xs font-medium">© <?= date('Y') ?> Mudsor (Rughwani Enterprises). GSTIN: 07FLOPR6641L1Z8.
    ...
    <div class="fixed inset-y-0 right-0 max-w-full flex sm:pl-10 z-[100000]">
        <div class="w-screen max-w-full sm:max-w-md bg-white dark:bg-slate-900 shadow-2xl flex flex-col">
            <div class="p-4 bg-gray-900 text-white flex items-center justify-between border-b border-gray-800">
                ...
                <button @click="cartDrawer = false" class="text-gray-400 hover:text-white p-1 rounded-lg transition"><i data-lucide="x"
            ...
            <div id="drawer-cart-items" class="flex-1 overflow-y-auto p-4 space-y-3">
                ...
                <?php else: ?>
                    ...
                    ?>
                        <div class="flex items-center justify-between border border-gray-100 dark:border-slate-800 rounded-xl p-3 bg-white dark:bg-slate-800/80 gap-3 shadow-2xs">
                            <div class="w-14 h-14 bg-gray-50 dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-slate-700 shrink-0 overflow-hidden flex items-center justify-center p-1">
                            ...
                            <div class="flex-1 min-w-0 space-y-1">
                                <h4 class="text-xs font-semibold text-gray-900 dark:text-white line-clamp-1"><?= htmlspecialchars($item['name']) ?></h4>
                                
                                <div class="flex items-center justify-between gap-2">
                                    <div class="inline-flex items-center border border-gray-200 dark:border-slate-700 rounded-lg bg-gray-50 dark:bg-slate-900 p-0.5 space-x-1">
                                        ...
                                        <span class="w-5 text-center font-semibold text-[11px] text-gray-900 dark:text-white"><?= $item['quantity'] ?></span>
                                        <form action="<?= url('cart/update') ?>" method="POST" class="inline">
                                            <?= csrf_field() ?>
                                            <input type="hidden" name="product_id" value="<?= $item['id'] ?>">
                                    ...
                                    <span class="text-xs font-bold text-red-600 dark:text-red-400"><?= format_price($itemTotal) ?></span>
                                </div>
                            </div>
            ...
            <div id="drawer-cart-footer"
                ...
                <div class="flex items-center justify-between text-xs font-bold text-gray-900 dark:text-white">
                    <span>Cart Subtotal</span>
                    <span class="text-sm text-red-600 dark:text-red-400"><?= format_price($drawerTotal ?? 0) ?></span>
                </div>
                <div class="grid grid-cols-2 gap-2">
                    <a href="<?= url('cart') ?>"
                        class="h-10 border border-red-600 bg-white text-red-600 hover:bg-red-600 hover:text-white dark:border-red-500 dark:bg-slate-900 dark:text-red-400 dark:hover:bg-red-600 dark:hover:text-white text-center font-bold text-xs rounded-xl transition flex items-center justify-center">View Cart</a>
                    <a href="<?= url('checkout') ?>"
                        class="h-10 bg-red-600 hover:bg-red-700 active:bg-red-800 text-white hover:text-white text-center font-bold text-xs rounded-xl shadow-md transition flex items-center justify-center">Checkout →</a>
                </div>
            </div>
        </div>
    </div>
...
<nav class="fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-gray-900 shadow-2xl md:hidden flex items-center justify-around h-16 px-0 text-gray-700 font-sans"
    ...
    <a href="<?= url('compare') ?>"
        ...
        <div class="relative">
            ...
            <span class="absolute -top-1.5 -right-2.5 bg-red-600 text-white text-[9px] font-semibold min-w-[15px] h-[15px] px-0.5 rounded-full flex items-center justify-center border border-white leading-none"><?= $compareNavCount ?></span>
            <?php endif; ?>
        </div>
    ...
    <!-- 5. WhatsApp -->
    <a href="https://wa.me/919217714452?text=Hi%20Mudsor%2C%20I%20am%20interested%20in%20wholesale%20scooter%20accessories."
        target="_blank" rel="noopener noreferrer"
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (typeof Swiper !== 'undefined') {
            ...
            // 9. Articles Swiper (1 per row on mobile)
