...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div class="bg-white rounded-2xl p-4 border border-gray-900 shadow-xs space-y-1">
            <span class="text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Total Redemptions</span>
            <div class="text-2xl font-black text-gray-900"><?= count($redemptions) ?></div>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-900 shadow-xs space-y-1">
            <span class="text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Discount Type</span>
        ...
        <div class="bg-white rounded-2xl p-4 border border-gray-900 shadow-xs space-y-1">
            <span class="text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Scope</span>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr
                        ...
                        <th class="py-3.5 px-4">Used Date & Time</th>
                        <th class="py-3.5 px-4">Order Reference</th>
                        <th class="py-3.5 px-4">Customer</th>
                        <th class="py-3.5 px-4">Order Total</th>
                        <th class="py-3.5 px-4 text-right">Discount Given</th>
                    </tr>
                </thead>
                    ...
                    <?php if (empty($redemptions)): ?>
                        <tr>
                            <td colspan="5" class="py-12 text-center text-gray-400">
                                ...
                                <p>No customer redemptions logged for this coupon yet.</p>
                            </td>
                        </tr>
                    <?php else: ?>
                        <?php foreach ($redemptions as $r): ?>
                            <tr class="hover:bg-gray-50/80 transition">
                                ...
                                <td class="py-3.5 px-4 text-right font-semibold text-green-600">
