    ...
    <div class="max-w-md w-full space-y-6">
        ...
        <div class="text-center space-y-2">
            <div class="flex items-center justify-center space-x-2">
                <img src="<?= url('assets/images/importwale-logo.png') ?>" alt="ImportWala" class="h-10 w-auto object-contain">
            </div>
        ...
        <div class="bg-white border border-slate-200/80 rounded-2xl p-8 shadow-sm space-y-6">
            ...
            <?php if ($flash = (new App\Core\Session())->getFlash('error')): ?>
                <div class="bg-rose-50 border border-rose-200 text-rose-700 text-xs p-3.5 rounded-xl font-medium flex items-center space-x-2">
            ...
            <?php if ($flash = (new App\Core\Session())->getFlash('success')): ?>
                <div class="bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs p-3.5 rounded-xl font-medium flex items-center space-x-2">
            ...
            <form action="<?= url('admin/login') ?>" method="POST" class="space-y-4">
                ...
                <div class="text-center pt-2">
                    <a href="<?= url('admin/forgot-password') ?>" class="text-xs font-medium text-slate-500 hover:text-[#f05a29] transition">
                        Forgot password?
                    </a>
                </div>
            </form>
