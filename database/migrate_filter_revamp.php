...
$filters = [
    ...
    ['Material',                           'material',                           'multi_select', 1, 0,  5],
    ['Metal Type',                         'metal_type',                         'multi_select', 1, 0,  6],
    ['Metal Color',                        'metal_color',                        'multi_select', 1, 0,  7],
    ['Main Stone Type',                    'main_stone_type',                    'multi_select', 1, 0,  8],
    ['Country of Origin',                  'country_of_origin',                  'multi_select', 1, 0,  9],
    ['Variety',                            'variety',                            'multi_select', 1, 0, 10],
    ['Processing Technology',              'processing_technology',              'multi_select', 1, 0, 11],
    ['Processing Technique',               'processing_technique',               'multi_select', 1, 0, 12],
    ['Treatment Process',                  'treatment_process',                  'multi_select', 1, 0, 13],
    ['Style',                              'style',                              'multi_select', 1, 0, 14],
    ['Style Classification',               'style_classification',               'multi_select', 1, 0, 15],
    ['Suitable For Gift Giving Occasion',  'suitable_for_gift_giving_occasion',  'multi_select', 1, 0, 16],
    ['Color',                              'color',                              'multi_select', 1, 0, 17],
    ['Popular Elements',                   'popular_elements',                   'multi_select', 1, 0, 18],
    ['Kind',                               'kind',                               'multi_select', 1, 0, 19],
    ['Product Type',                       'product_type',                       'multi_select', 1, 0, 20],
    ['Chain Style',                        'chain_style',                        'multi_select', 1, 0, 21],
    ['Pendant Material',                   'pendant_material',                   'multi_select', 1, 0, 22],
    ['Trendy Element',                     'trendy_element',                     'multi_select', 1, 0, 23],
    ['Closure Type',                       'closure_type',                       'multi_select', 1, 0, 24],
    ['Brand Name',                         'brand_name',                         'multi_select', 1, 0, 25],
    ['Price Range',                        'price_range',                        'range',        1, 0, 26],
    // ── Admin-only internal filters (is_admin_only = 1) ───────────────────
    ['Manufacturer Name',                  'manufacturer_name',                  'multi_select', 1, 1, 27],
    ['Source Platform',                    'source_platform',                    'multi_select', 1, 1, 28],
    ['Status',                             'status',                             'multi_select', 1, 1, 29],
];
