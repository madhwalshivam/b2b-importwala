...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/everful-theme.css">
...
<body>
  ...
  <header class="header-container">
    <div class="header-main">
      ...
      <form action="/catalog" method="GET" class="search-bar-wrapper">
      ...
      <div class="header-actions">
        ...
        <a href="/cart" class="header-action-item">
    ...
    <nav class="nav-categories-bar">
      <div class="nav-categories-inner">
        <a href="/" class="nav-category-link active">Home</a>
        <a href="/catalog" class="nav-category-link">All Products</a>
        <a href="/catalog?sort=newest" class="nav-category-link">New Arrivals</a>
        <a href="/catalog?sort=popular" class="nav-category-link">Best Sellers</a>
        <?php if (!empty($categories)): ?>
          <?php foreach ($categories as $cat): ?>
            <a href="/catalog?category_id=<?= $cat['id'] ?>" class="nav-category-link"><?= htmlspecialchars($cat['name']) ?></a>
          <?php endforeach; ?>
        <?php endif; ?>
      </div>
    </nav>
  ...
  <footer class="footer-container">
    <div class="footer-inner">
      ...
      <div class="footer-col">
        ...
        <ul>
          <li><a href="/catalog?category_id=1">Jewelry & Accessories</a></li>
          <li><a href="/catalog?category_id=2">Hats & Headwear</a></li>
          <li><a href="/catalog?category_id=3">Stationery & Office</a></li>
          <li><a href="/catalog?category_id=4">Socks & Apparel</a></li>
        </ul>
      </div>
    </div>
